import{d as x,L as _,I as w,c as l,a as e,b as v,u as y,f as T,J as m,K as f,E as d,o,_ as k}from"./index-DmevcAYo.js";const $={class:"tables-container"},z={class:"header-section"},D={class:"tables-grid"},M={class:"multiplication-table"},P={class:"number"},V={class:"number"},B={class:"result"},C=x({__name:"MultiplicationTablesView",setup(E){_();const c=w([]);function g(){const n=[];for(let t=1;t<=12;t++){const a=[];for(let s=1;s<=12;s++)a.push(t*s);n.push(a)}c.value=n}g();function h(){const t=`multiplication-tables-${new Date().toISOString().replace(/[:.]/g,"-").slice(0,19)}.pdf`,a=window.open("","_blank");if(!a)return;let s="";for(let i=0;i<12;i++){const b=i+1;let u="";for(let r=0;r<12;r++)u+=`
        <tr>
          <td>${b}</td>
          <td>×</td>
          <td>${r+1}</td>
