...
`)+_+`return __p
  ...
  `;I.document.write(k),I.document.close()}return(b,w)=>(U(),nn(lo,null,[G("div",bv,[(U(!0),nn(lo,null,Ja(r.value.values(),(I,W)=>(U(),it(uv,{key:W,max:I.max,"onUpdate:max":k=>I.max=k,min:I.min,"onUpdate:min":k=>I.min=k,size:I.size,"onUpdate:size":k=>I.size=k,match:I.match,operator:I.operator},null,8,["max","onUpdate:max","min","onUpdate:min","size","onUpdate:size","match","operator"]))),128))]),u.value.length>0?(U(),nn("div",gv,[ut(rt(Dr),{class:"p-button-raised",label:"Generate",onClick:c}),ut(rt(Dr),{class:"p-button-raised p-button-success",label:"Print Problems",onClick:x})])):(U(),nn("div",mv,[ut(rt(Dr),{class:"p-button-raised",label:"Generate",onClick:c})])),u.value.length>0?(U(),nn("div",vv,[(U(!0),nn(lo,null,Ja(u.value,(I,W)=>(U(),nn("div",{key:W,class:"result-card"},[G("div",yv,[G("div",_v,Bt(Math.max(I.firstNumber,I.secondNumber)),1),G("div",wv,Bt(I.operator)+" "+Bt(Math.min(I.firstNumber,I.secondNumber)),1),w[0]||(w[0]=G("div",{class:"separator"},"----------",-1)),w[1]||(w[1]=G("div",{class:"separator"},"----------",-1))])]))),128))])):ot("",!0)],64))}}),Sv=ll(xv,[["__scopeId","data-v-76434105"]]);export{Sv as default};
